...
// Covert type of the password field ;)
...
var solution1 = function () {
    ...
    var password = '', // actual password in plaintext to be sent to server
        ...
        hiddenlEl = $('#hiddenPass'), // hidden input element
